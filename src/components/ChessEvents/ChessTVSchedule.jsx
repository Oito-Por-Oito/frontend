  ...
  return (
    <div className="bg-[#181818]/90 border border-[#c29d5d]/20 shadow-lg p-4 sm:p-6 rounded-2xl">
      ...
      <div className="overflow-x-auto">
        <div className="grid grid-cols-4 border-t border-gray-600 min-w-[260px]">
          <div className="col-span-1">
            {hours.map((h, i) => (
              <div key={i} className="border-b border-gray-700 py-1 text-white/80 text-xs sm:text-sm">{h}</div>
            ))}
          </div>
