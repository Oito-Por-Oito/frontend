...
export default function ChessHome() {
  ...
  return (
    <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-center gap-0 lg:gap-12 px-2 sm:px-4 lg:px-8">
      ...
      {/* Sidebar/menu */}
      <div className="flex justify-center lg:justify-start w-full lg:w-auto mt-6 lg:mt-0 lg:ml-8">
